...
import { wrapMuiThemeLight, wrapMuiThemeDark, attachDispatchToProps,
     uppercase, insideTargetArea, selectCategoryBlock} from "../utils"; 
                  ...
                  map((tag:string) =>  
                      ...
                      <div className="chip"    
                          ...
                          style={{
                              ...
                              cursor: "pointer",
                              borderRadius: "100px",
                              backgroundColor: this.props.selectedTag === tag ? "dimgray" : "white",
                              fontWeight: 700,
