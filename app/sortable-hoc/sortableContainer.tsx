...
export default function SortableContainer(WrappedComponent, config = {withRef: false}) {
  return class extends Component<any,any>{
    ...
    displayName = provideDisplayName('sortableList', WrappedComponent);
      ...
      if (direction.x !== 0 || direction.y !== 0) {
        this.autoscrollInterval = setInterval(
          () => {
            ...
            if(this.props.shouldCancelAnimation){

                if(!this.props.shouldCancelAnimation(e))
                   this.animateNodes();
